...
export default function Table({ title, type }) {
    const { openShowModal, setAction, listClient, listUser, listProduct, controlerListe,setItemTomodify ,  setControlerListe} = useGlobalContext()
    ...
    const handleRmove = (item) => {
        ...
        axios.delete(`http://localhost:3001/api/delete/${id}/${type}`)
        .then(()=> {
                            ...
                            <td className="py-3 px-6 text-left whitespace-nowrap">
                                ...
                                <td className="py-3 px-6 text-center">
                                    <div className="flex item-center justify-center">
                                        ...
                                        <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" onClick={()=> {handleRmove(item); setControlerListe(!controlerListe)}}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
